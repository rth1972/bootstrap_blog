...
<div class="input-group">
  ...
  <input type="password" class="form-control" name="firstpassword" placeholder="New Password" required autofocus>
</div><br />
<div class="input-group">
  <span class="input-group-addon"><i class="fa fa-lock"></i></span>
...
<br />
    ...
    <div class="alert alert-success text-success" style='display:none;'>
        <strong>Success!</strong> Email has been send to you with a link to reset your password.
    </div>
